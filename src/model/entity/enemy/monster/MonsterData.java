...
/**
 * Monster data is used to store data retrieved from the SQLite database.
 * Created to resolve the bug created by creating Monsters as their data is
 * read in and then storing them in an List<Monster>. By using this, Monsters
 * can be truly unique to a room.
 *
 * @version 1.0.0
 * @author Patrick Hern
 */
